...
export const returnDrills: Drill[] = [
  {
    name: "Deep Return Lane",
    level: "foundation",
    purpose: "Create time to reach the kitchen with a deep, reliable return.",
    setup: "Mark the back third of each service court with flat markers or cones.",
    steps: [
      "Receive ten serves to one side.",
      "Use a controlled swing and aim through the centre of the deep target area.",
      "Move forward immediately after contact and finish balanced near the kitchen line.",
    ],
    socialTarget: "Land 7 of 10 returns in the back third and reach the kitchen under control.",
    competitiveTarget: "Land 9 of 10 deep with no more than one return error.",
    solo: "Drop-feed or use a rebound source, then move through the return-and-advance footwork.",
    partner: "The server provides moderate, repeatable serves and watches the returner's movement forward.",
  },
  {
    name: "Return and Arrive",
    level: "foundation",
    purpose: "Link return quality with efficient movement to the non-volley line.",
    setup: "The returner begins in a normal receiving position while a partner serves at comfortable pace.",
    steps: [
      "Return crosscourt with safe net clearance.",
      "Follow the ball forward using quick, controlled steps.",
      "Split-step before the opponent contacts the third shot.",
    ],
    socialTarget: "Complete 8 of 10 sequences with a legal return and balanced split-step.",
    competitiveTarget: "Complete 9 of 10 and neutralize the next ball on at least 7 repetitions.",
    solo: "Shadow the return, advance, and split-step sequence using a self-toss.",
    partner: "The server plays a controlled third shot after each return.",
  },
  {
    name: "Middle Is Safe",
    level: "foundation",
    purpose: "Reduce return errors by using a high-percentage target with room for margin.",
    setup: "Place a wide target strip through the middle third of the backcourt.",
    steps: [
      "Return twelve serves toward the middle target.",
      "Clear the net by a comfortable margin rather than driving low.",
      "Track legal returns, deep returns, and unforced errors separately.",
    ],
    socialTarget: "Make 10 of 12 returns with at least 7 reaching the back half.",
    competitiveTarget: "Make 11 of 12 with at least 9 reaching the back third.",
    solo: "Use self-fed balls and aim through the middle target lane.",
    partner: "The server varies placement slightly while maintaining manageable pace.",
  },
  {
    name: "Crosscourt Depth Ladder",
    level: "developing",
    purpose: "Improve crosscourt depth while controlling height and direction.",
    setup: "Create three depth bands in the crosscourt service box: short, middle, and deep.",
    steps: [
      "Start by landing two returns in the middle band.",
      "Progress to two returns in the deep band.",
      "Restart the ladder after an error or a return into the short band.",
    ],
    socialTarget: "Complete the ladder twice in ten minutes.",
    competitiveTarget: "Complete the ladder three times with no more than three total errors.",
    solo: "Drop-feed from a receiving position and move forward after each return.",
    partner: "The server changes pace slightly but keeps the ball within the returner's normal reach.",
    advancedVariation: "Alternate between deep crosscourt and deep middle targets without changing preparation.",
  },
  {
    name: "Handle the Hard Serve",
    level: "developing",
    purpose: "Maintain return depth and balance against pace or body serves.",
    setup: "The server alternates firm serves to the body, forehand, and backhand zones.",
    steps: [
      "Use a compact backswing and absorb pace rather than swinging harder.",
      "Prioritize height, depth, and recovery over speed.",
      "Advance only when the return is safely away.",
    ],
    socialTarget: "Return 8 of 12 firm serves legally and reach the kitchen on 6.",
    competitiveTarget: "Return 10 of 12 with at least 8 landing beyond midcourt.",
    solo: "Use a wall or rebound feed to practise compact contact and immediate recovery steps.",
    partner: "The server gradually increases pace while keeping placement controlled.",
    advancedVariation: "Play out the rally and award the returner a bonus point for reaching the kitchen before the third shot arrives.",
  },
  {
    name: "Read, Choose, Recover",
    level: "advanced",
    purpose: "Select return direction based on serve location while preserving depth and court position.",
    setup: "Mark deep crosscourt, deep middle, and deep down-the-line targets. The server varies direction and pace.",
    steps: [
      "Read the serve early and choose the safest deep target.",
      "Use the same preparation for each directional choice.",
      "Recover toward the kitchen while maintaining awareness of the third-shot hitter.",
    ],
    socialTarget: "Choose the appropriate target on 9 of 15 serves and land 10 returns deep.",
    competitiveTarget: "Choose correctly on 12 of 15 and create a neutral or weak third shot on 9.",
    solo: "Use shuffled target cards paired with self-fed balls from different starting positions.",
    partner: "The server varies serve location and then plays the third shot to test the returner's recovery.",
    advancedVariation: "Play full points and score two points when the return choice directly produces a weak third shot.",
  },
];
